		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				...
				<li class="dropdown head-dpdn">
					...
					<li class="dropdown head-dpdn">
						<a href="login.php" class="dropdown-toggle"> <i class="fa fa-user" aria-hidden="true"></i>Login</span></a>
					</li>
										
					<li class="dropdown head-dpdn">
						<a href="signup.php" class="dropdown-toggle"> <i class="fa fa-user" aria-hidden="true"></i>Signup</a>
					</li>	
				</ul>
			</div>
