				...
				<div class="products-row">
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="tempbycat.php?id=<?php echo $row['cat_id']; ?>"><img height="100px" src="<?php echo $row['subcat_image']; ?>" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="tempbycat.php"><?php echo $row['subcat_name']; ?></a></h5> 
